...
function App() {
  ...
  return (
    <div className="app">
      ...
      {showWasteForm && (
        <div className="modal-overlay" style={{ background: "rgba(15, 55, 38, 0.48)", backdropFilter: "blur(4px)", padding: "24px" }}>
          <div className="modal" style={{ width: "min(900px, 95vw)", maxWidth: "900px", maxHeight: "92vh", overflowY: "auto", overflowX: "hidden", padding: 0, borderRadius: "22px", background: "#fff" }}>
            <div style={{ position: "relative", padding: "30px 34px 24px", background: "linear-gradient(135deg,#edf9f1,#f8fcf9)", borderBottom: "1px solid #d9ece0" }}>
              <button className="close-btn" onClick={() => setShowWasteForm(false)} style={{ position: "absolute", right: "18px", top: "14px", width: "38px", height: "38px", borderRadius: "50%", border: "1px solid #cfe4d7", background: "#fff", color: "#245b43", fontSize: "25px", cursor: "pointer" }}>×</button>
              <div style={{ fontSize: "36px", marginBottom: "8px" }}>♻️</div>
              <h2 style={{ margin: 0, color: "#145c3b", fontSize: "30px" }}>Post Industrial Waste</h2>
              <p style={{ margin: "8px 0 0", color: "#587166", lineHeight: 1.5 }}>Provide complete waste details so EcoSync can identify suitable reuse opportunities.</p>
            </div>

            <div style={{ padding: "28px 32px 32px", background: "#fbfefc" }}>
              <form onSubmit={handleWasteSubmit}>
                <div style={{ padding: "20px", borderRadius: "16px", background: "#f0faf4", border: "1px solid #d8ebdf", marginBottom: "18px" }}>
                  <h3 style={{ margin: "0 0 16px", color: "#17613f" }}>🏢 Industry Details</h3>
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: "18px" }}>
                    <div><label style={pickupLabelStyle}>Company Name</label><input style={pickupInputStyle} placeholder="Enter company name" value={wasteForm.companyName} onChange={(e) => setWasteForm({ ...wasteForm, companyName: e.target.value })} required /></div>
                    <div><label style={pickupLabelStyle}>Industry Type</label><input style={pickupInputStyle} placeholder="e.g. Paper Manufacturing" value={wasteForm.industryType} onChange={(e) => setWasteForm({ ...wasteForm, industryType: e.target.value })} required /></div>
                    <div><label style={pickupLabelStyle}>Location</label><input style={pickupInputStyle} placeholder="Enter city / location" value={wasteForm.location} onChange={(e) => setWasteForm({ ...wasteForm, location: e.target.value })} required /></div>
                  </div>
                </div>

                <div style={{ padding: "20px", borderRadius: "16px", background: "#fff", border: "1px solid #dfeae3", marginBottom: "20px", boxShadow: "0 5px 18px rgba(35,91,64,.05)" }}>
                  <h3 style={{ margin: "0 0 16px", color: "#17613f" }}>♻️ Waste Details</h3>
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: "18px" }}>
                    <div><label style={pickupLabelStyle}>Waste Type</label><input style={pickupInputStyle} placeholder="e.g. Sugarcane Bagasse" value={wasteForm.wasteType} onChange={(e) => setWasteForm({ ...wasteForm, wasteType: e.target.value })} required /></div>
                    <div><label style={pickupLabelStyle}>Available Quantity</label><input style={pickupInputStyle} type="number" min="1" placeholder="Enter quantity" value={wasteForm.quantity} onChange={(e) => setWasteForm({ ...wasteForm, quantity: e.target.value })} required /></div>
                    <div><label style={pickupLabelStyle}>Unit</label><select style={pickupInputStyle} value={wasteForm.unit} onChange={(e) => setWasteForm({ ...wasteForm, unit: e.target.value })}><option>Kg</option><option>Ton</option><option>Litres</option></select></div>
                    <div><label style={pickupLabelStyle}>Quality</label><select style={pickupInputStyle} value={wasteForm.quality} onChange={(e) => setWasteForm({ ...wasteForm, quality: e.target.value })}><option>High</option><option>Medium</option><option>Low</option></select></div>
                    <div><label style={pickupLabelStyle}>Availability Date</label><input style={pickupInputStyle} type="date" value={wasteForm.availabilityDate} onChange={(e) => setWasteForm({ ...wasteForm, availabilityDate: e.target.value })} required /></div>
                  </div>
                </div>

                <div style={{ display: "flex", justifyContent: "flex-end", gap: "12px" }}>
                  <button type="button" onClick={() => setShowWasteForm(false)} style={{ padding: "13px 22px", borderRadius: "10px", border: "1px solid #cbded3", background: "#fff", color: "#426454", fontWeight: 600, cursor: "pointer" }}>Cancel</button>
                  <button className="primary-btn" type="submit" style={{ padding: "13px 26px", borderRadius: "10px", fontWeight: 700 }}>Submit Waste</button>
                </div>
              </form>
            </div>
          </div>
      ...
      {showRequirementForm && (
        <div className="modal-overlay" style={{ background: "rgba(15, 55, 38, 0.48)", backdropFilter: "blur(4px)", padding: "24px" }}>
          <div className="modal" style={{ width: "min(900px, 95vw)", maxWidth: "900px", maxHeight: "92vh", overflowY: "auto", overflowX: "hidden", padding: 0, borderRadius: "22px", background: "#fff" }}>
            <div style={{ position: "relative", padding: "30px 34px 24px", background: "linear-gradient(135deg,#edf9f1,#f8fcf9)", borderBottom: "1px solid #d9ece0" }}>
              <button className="close-btn" onClick={() => setShowRequirementForm(false)} style={{ position: "absolute", right: "18px", top: "14px", width: "38px", height: "38px", borderRadius: "50%", border: "1px solid #cfe4d7", background: "#fff", color: "#245b43", fontSize: "25px", cursor: "pointer" }}>×</button>
              <div style={{ fontSize: "36px", marginBottom: "8px" }}>🔎♻️</div>
              <h2 style={{ margin: 0, color: "#145c3b", fontSize: "30px" }}>Post Waste Requirement</h2>
              <p style={{ margin: "8px 0 0", color: "#587166", lineHeight: 1.5 }}>Tell EcoSync exactly what waste material your industry needs.</p>
            </div>
            ...
            <div style={{ padding: "28px 32px 32px", background: "#fbfefc" }}>
              <form onSubmit={handleRequirementSubmit}>
                <div style={{ padding: "20px", borderRadius: "16px", background: "#f0faf4", border: "1px solid #d8ebdf", marginBottom: "18px" }}>
                  <h3 style={{ margin: "0 0 16px", color: "#17613f" }}>🏢 Industry Details</h3>
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: "18px" }}>
                    <div><label style={pickupLabelStyle}>Company Name</label><input style={pickupInputStyle} placeholder="Enter company name" value={requirementForm.companyName} onChange={(e) => setRequirementForm({ ...requirementForm, companyName: e.target.value })} required /></div>
                    <div><label style={pickupLabelStyle}>Industry Type</label><input style={pickupInputStyle} placeholder="e.g. Paper Manufacturing" value={requirementForm.industryType} onChange={(e) => setRequirementForm({ ...requirementForm, industryType: e.target.value })} required /></div>
                    <div><label style={pickupLabelStyle}>Location</label><input style={pickupInputStyle} placeholder="Enter city / location" value={requirementForm.location} onChange={(e) => setRequirementForm({ ...requirementForm, location: e.target.value })} required /></div>
                  </div>
                </div>

                <div style={{ padding: "20px", borderRadius: "16px", background: "#fff", border: "1px solid #dfeae3", marginBottom: "20px", boxShadow: "0 5px 18px rgba(35,91,64,.05)" }}>
                  <h3 style={{ margin: "0 0 16px", color: "#17613f" }}>♻️ Waste Requirement</h3>
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: "18px" }}>
                    <div><label style={pickupLabelStyle}>Required Waste Type</label><input style={pickupInputStyle} placeholder="e.g. Sugarcane Bagasse" value={requirementForm.wasteType} onChange={(e) => setRequirementForm({ ...requirementForm, wasteType: e.target.value })} required /></div>
                    <div><label style={pickupLabelStyle}>Required Quantity</label><input style={pickupInputStyle} type="number" min="1" placeholder="Enter required quantity" value={requirementForm.quantity} onChange={(e) => setRequirementForm({ ...requirementForm, quantity: e.target.value })} required /></div>
                    <div><label style={pickupLabelStyle}>Unit</label><select style={pickupInputStyle} value={requirementForm.unit} onChange={(e) => setRequirementForm({ ...requirementForm, unit: e.target.value })}><option>Kg</option><option>Ton</option><option>Litres</option></select></div>
                    <div><label style={pickupLabelStyle}>Minimum Quality</label><select style={pickupInputStyle} value={requirementForm.minimumQuality} onChange={(e) => setRequirementForm({ ...requirementForm, minimumQuality: e.target.value })}><option>High</option><option>Medium</option><option>Low</option></select></div>
                    <div><label style={pickupLabelStyle}>Required Date</label><input style={pickupInputStyle} type="date" value={requirementForm.requiredDate} onChange={(e) => setRequirementForm({ ...requirementForm, requiredDate: e.target.value })} required /></div>
                  </div>
                </div>

                <div style={{ padding: "14px 16px", marginBottom: "20px", borderRadius: "12px", background: "#f4faf6", border: "1px solid #dcebe2", color: "#557066", fontSize: "14px" }}>
                  🤖 <strong style={{ color: "#17613f" }}>EcoSync AI Matching:</strong> Your requirement will be compared with available waste based on waste type, quantity, quality, location and industry details.
                </div>

                <div style={{ display: "flex", justifyContent: "flex-end", gap: "12px" }}>
                  <button type="button" onClick={() => setShowRequirementForm(false)} style={{ padding: "13px 22px", borderRadius: "10px", border: "1px solid #cbded3", background: "#fff", color: "#426454", fontWeight: 600, cursor: "pointer" }}>Cancel</button>
                  <button className="primary-btn" type="submit" style={{ padding: "13px 26px", borderRadius: "10px", fontWeight: 700 }}>Find AI Matches</button>
                </div>
              </form>
            </div>
          </div>
